...
public class CreativeWritingTest {
  public static void main(String[] args) {
    RSSFeedParser parser = new RSSFeedParser("http://sagecreektimes.weebly.com/10/feed");
    ...
    mostRecentMessage.setAuthor("Grace McGuire");
